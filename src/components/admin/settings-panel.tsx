...
const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    icon: "⚡",
    fields: [
      { key: "hero_boost_enabled", label: "Hero Boost enabled", type: "boolean" },
      { key: "hero_boost_price", label: "Hero Boost price", type: "number", suffix: "paise" },
      { key: "hero_boost_duration_days", label: "Hero Boost duration", type: "number", suffix: "days" },
      { key: "hero_rotation_interval_minutes", label: "Rotation interval", type: "number", suffix: "min" },
      { key: "hero_max_visible_events", label: "Max visible hero events", type: "number" },
