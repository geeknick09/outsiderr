...
truncate table public.event_staff restart identity cascade;
truncate table public.admin_change_log restart identity cascade;
truncate table public.webhook_events restart identity cascade;
truncate table public.payment_ledger restart identity cascade;
truncate table public.payout_records restart identity cascade;
